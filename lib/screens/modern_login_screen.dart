    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          labelText: label,
          labelStyle: TextStyle(color: subFontColor.withOpacity(0.8)),
          prefixIcon: Icon(icon, color: primaryColor, size: 20),
          suffixIcon: suffixIcon,
          filled: true,
          fillColor: cardBackgroundColor.withOpacity(0.8),
        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: isPrimary
                ...
                : LinearGradient(
                    colors: [cardBackgroundColor, cardBackgroundColor.withOpacity(0.8)],
                    begin: Alignment.centerLeft,
                    end: Alignment.centerRight,
                  ),
            borderRadius: BorderRadius.circular(16),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildSocialButton(
                                ...
                                imagePath: 'assets/khelset_logo.png', // Using app logo as phone icon placeholder
