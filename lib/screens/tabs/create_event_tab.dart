...
class _CreateEventTabState extends State<CreateEventTab> with TickerProviderStateMixin {
          ...
          builder: (context, authSnapshot) {
            ...
            return FutureBuilder<DocumentSnapshot>(
              ...
              builder: (context, userSnapshot) {
                ...
                // user data fetched but we're showing the organizer portal directly
                // For now show organizer portal directly to signed-in users.
                // Previously non-organizers saw an upgrade prompt; we bypass that.
  ...
  // Upgrade section removed; showing organizer portal directly.
